export default function CatalogSearch() {
    return(
        <div className="relative flex w-[25rem] md:w-[50rem] h-12 justify-center rounded">
            ...
            <button id="search-catalog-button" className="relative w-14 h-full rounded-r-xl bg-no-repeat bg-[center_top_50%] bg-[#BEDB1A]" style={{backgroundImage:'url("/Magnifying Glass.svg")'}}/>
        </div>
    );
}